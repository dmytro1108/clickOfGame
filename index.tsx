...
interface GridDimensions {
    height: number;
    width: number;
    clickable?: React.JSX.Element | React.JSX.Element[];
}
 ...
 */
class Board extends Component<GridDimensions, GetTheCoords> {
    game: GameModel;
    // empty object cell array
    cellObj: cell[] = []
    constructor(props: GridDimensions) {
        super(props);
    ...
    override render(): ReactNode {
        ...
        // render canvas
        const cnvs = 
            <canvas id = "theGameBoard"
                width = {this.props.height}
                height = {this.props.height}
                style ={{border: "10px solid rgb(201, 139, 210)",
        ...
        <div
            ...
            {grid.map((cell, lc) => (
                ...
                <div key = {lc}
                    ...
                    style = {{border: "1px solid black", cursor: "pointer", width: 60, height: 60, color: cell.color, background: cell.color}}>
    ...
    addClick = (row: number, col: number): void => {
...
class GameModel {
    ...
    // contains a method that takes a click coordinate and changes the color in the cell
    // from black to white

    // reference the cell objects
    cellObjects: cell[];
    count: number;
